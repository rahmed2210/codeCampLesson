...
curly braces. When the Boolean condition evaluates to false, the statement inside 
...
test(true);
test(false);
test(true) returns the string It was true, and test(false) returns 
the string It was false.
